...
export default async function ToolsPage() {
  ...
  const breadcrumbItems = generateGeneralBreadcrumbs("Tools", "tools", lang);
  ...
  const tools = [
    {
      ...
      description:
        "Professional suite of 6 calculators for cargo volume, weight, and container optimization. Includes volumetric weight, multiple products, and container loading analysis.",
      icon: "📦",
      features: [
    ...
    },
    {
      ...
      description:
        "Professional tool for calculating required tie-down capacity based on cargo weight, securing method, and angle. Default units: pounds and feet.",
      icon: "🔗",
      features: [
    ...
    },
    {
      ...
      description:
        "Quick tool to see how tie-down angle affects your strap's actual working capacity. Instant visual feedback. Default units: pounds.",
      icon: "📐",
      features: [
    ...
    },
    {
      ...
      description:
        "Get personalized strap recommendations for your specific cargo type. No technical knowledge required - just tell us what you're securing!",
      icon: "🎯",
      features: [
  ...
  return (
    <div>
      ...
      <div className="mx-auto w-full container px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto text-center mb-12">
          ...
          <p className="mt-3 text-lg text-black/70">
            Expert tools designed to help you optimize cargo operations, ensure
            safety compliance, and make informed decisions for your
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Based on DOT regulations and international best practices
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Real-time calculations with professional recommendations
              </p>
            </div>
