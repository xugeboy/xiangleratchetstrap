...
export function SecuringMethodForm({
  value,
  onChange,
  onSubmit,
  onBack,
}: SecuringMethodFormProps) {
  const methods = [
    {
      id: "indirect" as SecuringMethod,
      title: "Indirect Tie-Down (Over-the-top)",
      description:
        "Straps go over the top of the cargo and connect to the vehicle",
      features: [
    ...
    },
    {
      ...
      description:
        "Straps directly connect cargo attachment points to the vehicle",
      features: [
    ...
    <div className="container mx-auto">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">
          Step 2: Securing Method
        </h2>
        <p className="text-gray-600">
          Choose how you plan to secure your cargo. This affects the required
          tie-down capacity.
        </p>
      </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700">
              <p>
                The indirect tie-down method requires angle consideration as the
                effective securing force decreases with smaller angles. Always
                ensure your tie-downs meet or exceed the calculated requirements
