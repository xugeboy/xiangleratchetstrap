  ...
  return (
    <div className="bg-white py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {/* Logo Grid */}
        <div className="mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-8 items-center mb-16">
        ...
        <div className="text-center max-w-4xl mx-auto">
          <blockquote className="text-xl text-gray-700 mb-4">
            &quot;US CARGO CONTROL HAS BEEN AN AMAZING VENDOR WITH FAST RESPONSE TIME, AMAZING CUSTOMER SERVICE, AND GREAT FOLLOW-UP. BY FAR ONE OF OUR EASIEST AND BEST VENDORS TO DEAL WITH.&quot;
          </blockquote>
          <cite className="text-gray-600 italic">- General Manager, Fastenal</cite>
        </div>
      </div>
    </div>
  )
