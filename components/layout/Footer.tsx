...
export default function Footer() {
  ...
  const navigation = {
    ...
    support: [
      ...
      { nameKey: "support.tools", href: "tools" },
      { nameKey: "support.sitemap", href: "https://xiangleratchetstrap.com/sitemap.xml" },
    ],
    products: [
      {
      ...
      <div className="mx-auto container px-4 py-2">
        ...
        <div className="mt-12 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-sm/6 text-white md:order-1 md:mt-0">
            &copy; 2026 Xiangle Ratchet Strap. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
