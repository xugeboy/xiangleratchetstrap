...
const navigation = {
    ...
    contactUs: [
      { 
        name: 'Address', 
        value: 'No. 18 Zhenxing Road, Yangshe Town, Zhangjiagang City, Suzhou, China, 215600', 
        icon: MapPinIcon,
        ...
        <div className="mx-auto max-w-7xl px-6 py-2">
          <div className="border-t border-white/10 pt-12 xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div>
                <h3 className="text-base font-semibold text-[#00e41b]">Products</h3>
              ...
              <div>
                <h3 className="text-base font-semibold text-[#00e41b]">Support</h3>
                <ul role="list" className="mt-6 space-y-4">
              ...
              <div>
                <h3 className="text-base font-semibold text-[#00e41b]">Company</h3>
                <ul role="list" className="mt-6 space-y-4">
              ...
              <div>
                <h3 className="text-base font-semibold text-[#00e41b]">Contact Us</h3>
                <div className="mt-6 space-y-4">
                    {navigation.contactUs.map((item) => (
                        ...
                        >   
                            {item.name === 'Address' ? (
                                <item.icon className="h-10 w-10 text-gray-600" aria-hidden="true" />
                            ) : (
