...
export default function HeroSection() {
  ...
  return (
    <div 
      ...
      className="relative w-full h-screen sticky top-0 -z-10 overflow-hidden"
    >
      
      {/* === Preloader Layer === */}
      <div
        ref={loaderRef}
        className="fixed inset-0 z-50 flex items-center justify-center bg-[#0f0f0f] text-white"
      >
        <h2 className="loader-text text-4xl font-serif opacity-0">
          Xiangle Tools
        </h2>
      </div>
